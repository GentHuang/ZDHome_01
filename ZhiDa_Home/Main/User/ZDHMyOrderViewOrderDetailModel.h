//
//  ZDHMyOrderViewOrderDetailModel.h
//  ZhiDa_Home
//
...
@interface ZDHMyOrderViewOrderDetailModel : NSObject
@property (strong, nonatomic) NSString *addresult;
@property (strong, nonatomic) ZDHMyOrderViewOrderDetailBespokeDetailModel *bespoke_detail;
