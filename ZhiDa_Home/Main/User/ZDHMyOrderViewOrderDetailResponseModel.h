//
//  ZDHMyOrderViewOrderDetailResponseModel.h
//  ZhiDa_Home
//
...
@interface ZDHMyOrderViewOrderDetailResponseModel : NSObject
...
@property (strong, nonatomic) NSMutableArray *bespoke_poinion;
