...
@interface ZDHRightViewStyleView()
...
@implementation ZDHRightViewStyleView
...
- (void)buttonPressed:(UIButton *)button{
    ...
    //发出通知
    [[NSNotificationCenter defaultCenter] postNotificationName:@"风格" object:self userInfo:@{@"index":[NSNumber numberWithInteger:(button.tag-kButtonTag)]}];
}
