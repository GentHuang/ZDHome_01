//
//  ZDHSearchViewControllerListProtypelistModel.m
//  ZhiDa_Home
//
...
@implementation ZDHSearchViewControllerNewListProtypelistModel
- (instancetype)init{
    if (self = [super init]) {
...
- (void)setValue:(id)value forKey:(NSString *)key{
    if ([key isEqualToString:@"chindtype"]) {
        for (NSDictionary *dic in value) {
            ZDHSearchViewControllerNewListProtypelistChindtypeModel *chindModel = [ZDHSearchViewControllerNewListProtypelistChindtypeModel alloc];
